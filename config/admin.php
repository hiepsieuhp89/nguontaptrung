...
return [
    ...
    */
    ...
    | also set it as an image by using a `img` tag, egLoa
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Laravel-admin minify css and js
    |--------------------------------------------------------------------------
    |
    |
    */
    ...
    */
    ...
    |
    */
    'login_background_image' => '/images/bg_loa.jpg',
    ...
    */
    'extensions' => [
        'media-manager' => [
            'disk' => 'upload'   // Points to the disk set in config/filesystem.php
        ],
        'chartjs' => [
            'enable' => true,
        ],
